...
joining_topic = app.topic('people_joining2', key_type=str, value_type=str).maybe_declare()
leaving_topic = app.topic('people_leaving2', key_type=str, value_type=str).maybe_declare()
